...
impl Key {
    ...
    pub fn virt(&self) -> Option<VirtualKey> {
        match self.code() {
            0x1 => Some(VirtualKey::Escape),
            0x2 => Some(VirtualKey::Key1),
            0x3 => Some(VirtualKey::Key2),
            0x4 => Some(VirtualKey::Key3),
            0x5 => Some(VirtualKey::Key4),
            0x6 => Some(VirtualKey::Key5),
            0x7 => Some(VirtualKey::Key6),
            0x8 => Some(VirtualKey::Key7),
            0x9 => Some(VirtualKey::Key8),
            0xA => Some(VirtualKey::Key9),
            0xB => Some(VirtualKey::Key0),

            0xC => Some(VirtualKey::Minus),
            0xD => Some(VirtualKey::Equals),

            0xE => Some(VirtualKey::Back),
            0xF => Some(VirtualKey::Tab),
